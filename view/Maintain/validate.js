...
const validate = (values) => {
    ...
    errors.complain_ticket_no = !values.complain_ticket_no
        ? 'Complain Ticket No: field is required'
        : undefined;
    ...
    if (values.amount) {
        errors.payment_date = !values.payment_date
            ? 'Payment Date field is required'
            : undefined;

        errors.payment_method = !values.payment_method
