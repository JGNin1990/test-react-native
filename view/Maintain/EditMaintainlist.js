...
// export default function EditMaintainlist() {
//     return (
//         <View>
//             <Text>EditMaintainlist</Text>
//         </View>
//     )
// }
...
import { maintain_reject } from '../../src/redux/MaintainReducer'
...
const EditMaintainList = (props) => {
    ...
    useEffect(() => {
        ...
        image_array && image_array.map((image) => {
            imageArrayList.push({
                path: PHOTO_URL + '/ticket_report/' + image,
                name: image,
                type: image.mime
            })
        })
        ...
        // setDate(get_arraivaldate[0])
        // setTime(get_arraivaldate[1])
        // setCompletedate(get_completedate[0])
        // setCompletetime(get_completedate[1])
    ...
    const imageGalleryLaunch = () => {
        ...
        ImagePicker.openPicker({
            ...
            .then(response => {
                ...
                // imageList.length > 0 ? setmages(imageArray.concat(imageList)) : setmages(imageArray)
                setmages(imageList)
            });
    }
    ...
    const btnsend = (value) => {
        ...
        value = Object.assign({}, value, {
            ...
            arrival_date_time: value.arrival_date + '-' + value.arrival_time,
            complete_date_time: value.complete_date + '-' + value.complete_time,
            old_fatport: data.fatboxport_data.box_port,
            // arrival_date_time: date + '-' + value.arrival_time,
            // complete_date_time: completedate + '-' + value.complete_time,
            // arrival_date: date,
            // arrival_time: time,
        ...
        props.maintain_reject(images, value, (type) => {
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: 'white', }}>
            <View style={{
                ...
                <Field placeholder='Ticket Number' formname name="ticket_no" component={CustomTextInput} editable />
...
const ServiceReportwrap = reduxForm({
    form: "editmaintainreportform",
    validate
})(EditMaintainList)

export default connect(stateToprops, { maintain_reject, fetch_all_withdrawals, fetch_fatbox_ports, fetch_fetbox })(ServiceReportwrap)